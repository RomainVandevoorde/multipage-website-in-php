    ...
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-5 col-xl-5">
       ...
       <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
         <img src="assets/img/image-perm.png" class="img-fluid proImgTop mx-auto d-block" alt="Responsive image">
       </div>
  ...
  <div class="container proDiv proDivSpace" id="enFe">
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
       ...
       <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
         <img src="assets/img/image-enfé-1.png" class="img-fluid mx-auto d-block" alt="Responsive image">
       </div>
    </div>
  </div>
